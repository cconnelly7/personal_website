            ...
            <ul class="timeline">
                <li>
                    <div class="direction-r">
                        ...
                        <img class='logo' data-aos="fade-left" src='./logos/icon1.png'></img>
                    </div>
                </li>
                ...
                <li>
                    ...
                    While there, I built up my skills with JavaScript, redux, their APIs and services used, React Native, HTML, and CSS. I also worked on a project in React Native while working with Verizon.</div>
                ...
                <li>
                    <div class="direction-r">
                        <div class="flag-wrapper">
                            <span class="circ" data-aos="zoom-out"></span>
                            <span class="flag" data-aos="fade-left">Others</span>
                        </div>
                    <div class="desc" data-aos="fade-left"> During my time in school and working both at Verizon and NCR I have become familiar 
